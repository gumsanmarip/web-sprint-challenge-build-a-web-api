...
Node.js and Express are used to communicate with the database.

2. Understand and explain the use of Middleware.
Middleware is the function that receives the request and response objects.

3. The basic principles of the REST architectural style.
The Rest architectural style is allowing a resource with a URL on a server to be manipulate various ways as allowed.

4. Understand and explain the use of Express Routers.
Express routers are how you access information from a server. 

5. Describe tooling used to manually test the correctness of an API.
Tooling used to manually test API such as Postman allows you to make requests and receive responses.